...
/*---------------------------------------------------------------------*/   
    ...
    uint8_t   ConfigureSBAS(boolean en_SBAS, uint8_t ranging, uint8_t URA_mask, boolean en_corr, uint8_t channels, uint8_t subsys_mask, uint8_t attributes);
    uint8_t   SetQZSS(uint8_t Enable,uint8_t channel,uint8_t attribute);
